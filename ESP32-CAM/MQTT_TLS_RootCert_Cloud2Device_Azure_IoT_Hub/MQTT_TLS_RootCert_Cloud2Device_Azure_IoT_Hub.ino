...
//this sketch demos implementing an on/off switch using Azure IoT Hub cloud-to-device message using MQTT protocol.
//to test sending commands to the device, use Azure IoT explorer: https://github.com/Azure/azure-iot-explorer/releases
...
const char* _pubTopic = "devices/<device_id>/messages/events/"; //eg. const char* _pubTopic = "devices/mydevice1/messages/events/";
...
Fdtom/DzMNU+MekjkjfiuolfkfirE6Vf8PlwUHBHQRFXGU7Aj64GxJUTFy8bJZ91
...
ggEPADCCAQoCggEBALk8dgnkfkfrckjkcorllupTn3HKVE2UxJHNnEjNh5GHOLVW
...
rrLnOCDKWepmFqrVBLsffdfcrKlfk0flflc/bXpbZUBrSF6BbMRn58omJ5rTmgpf
...
void connectToMqttServer() {  
  ...
  while (!_mqttClient.connected()) {
    ...
    if (_mqttClient.connect(_deviceId, _mqttUserName, _mqttPassword)) {
      ...
      publishMessage(_pubTopic, "s:connected"); //sample device 2 cloud message
    } else {
